...
export const apiWaybill = createApi({
    ...
    endpoints: builder => ({
        ...
        updateWaybill: builder.mutation({
            query: ({ updateId, waybillData}) => ({
                url: `waybills/${updateId}`,
                method: 'PUT',
                body: waybillData
            }),
            invalidatesTags: ['success']
...
export const { useGetWaybillsQuery, useCreateWaybillMutation, useUpdateWaybillMutation, useDeleteWaybillMutation} = apiWaybill